...
public:
	...
	s32 compute_volume(u32 phase, u32 am_offset, int chn = 0) const;

	// compute volume for the OPM noise channel
	s32 compute_noise_volume(u32 am_offset, int chn = 0) const;
...
public:
	...
	void output_4op(int chn, s32 outputs[RegisterType::OUTPUTS], u32 rshift, s32 clipmax, u32 mute_mask_operators) const;
...
public:
	...
	void output(s32 outputs[RegisterType::OUTPUTS], u32 rshift, s32 clipmax, u32 chanmask, u32 mute_mask, u32 channel_special_mute_operators, u32 mute_mask_per_operator) const;
...
extern int mute_mask_special_operators;

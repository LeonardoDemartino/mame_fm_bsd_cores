...
public:
	// constructor
	ymadpcm_a_channel(ymadpcm_a_engine &owner, u32 choffs, u32 shift);
	...
	bool clock(unsigned char *memory, unsigned int size);
...
public:
	...
	// constructor
	ymadpcm_a_engine(u32 addrshift);

	// reset our status
	void reset();

	void set_memory(unsigned char *memory, unsigned int size);

	// master clocking function
	u32 clock(u32 chanmask);

	// compute sum of channel outputs
	void output(s32 outputs[ymadpcm_a_registers::OUTPUTS], u32 chanmask, int mute_mask);
...
public:
	...
	// constructor
	ymadpcm_b_channel(ymadpcm_b_engine &owner, u32 addrshift);
...
public:
	...
	// constructor
	ymadpcm_b_engine(u32 addrshift);
	...
	// compute sum of channel outputs
	void output(s32 outputs[2], u32 rshift, u32 chanmask, int mute_mask);
